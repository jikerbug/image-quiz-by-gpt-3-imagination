...
const description = `you are a famous painter and designer with incredible perception and imagination. create a set of drawings showing random animal in creative and imaginary way, with detailed description as it can be`; 
...
module.exports = async function getImagination(animal) {
